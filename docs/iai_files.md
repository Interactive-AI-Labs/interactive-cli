...
Manage documents stored in a project

### Synopsis

Put documents into a project, list what it holds, and fetch them back. Works with API key (--api-key or INTERACTIVE_API_KEY) or session from 'iai login'.
