...
This command requires API key authentication.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		body, err := inputs.BuildQueueItemCreateBody(
...
func init() {
	...
	queueItemsListCmd.Flags().
		StringVarP(&queueItemsListOrg, "organization", "o", "", "Organization name")
	queueItemsListCmd.Flags().
	...
	queueItemsGetCmd.Flags().
		StringVarP(&queueItemsGetOrg, "organization", "o", "", "Organization name")
	queueItemsGetCmd.Flags().
	...
	queueItemsCreateCmd.Flags().
		StringVarP(&queueItemsCreateOrg, "organization", "o", "", "Organization name")
	queueItemsCreateCmd.Flags().
	...
	queueItemsUpdateCmd.Flags().
		StringVarP(&queueItemsUpdateOrg, "organization", "o", "", "Organization name")
	queueItemsUpdateCmd.Flags().
	...
	queueItemsDeleteCmd.Flags().
		StringVarP(&queueItemsDeleteOrg, "organization", "o", "", "Organization name")
	queueItemsDeleteCmd.Flags().
