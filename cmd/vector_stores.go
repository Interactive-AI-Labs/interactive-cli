...
func init() {
	...
	vsCreateCmd.Flags().Float64Var(&vsMemory, "memory", 0, "Memory in GB (0.25 increments)")
	vsCreateCmd.Flags().IntVar(&vsStorageSize, "storage-size", 0, "Storage size in GB (min 20)")
