...
func init() {
	...
	commentsListCmd.Flags().
		StringVarP(&commentsListOrg, "organization", "o", "", "Organization name")
	commentsListCmd.Flags().
	...
	commentsGetCmd.Flags().
		StringVarP(&commentsGetOrg, "organization", "o", "", "Organization name")
	commentsGetCmd.Flags().
	...
	commentsCreateCmd.Flags().
		StringVarP(&commentsCreateOrg, "organization", "o", "", "Organization name")
	commentsCreateCmd.Flags().
