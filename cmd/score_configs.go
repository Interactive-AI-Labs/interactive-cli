...
func init() {
	...
	scoreConfigsListCmd.Flags().
		StringVarP(&scoreConfigsListOrg, "organization", "o", "", "Organization name")
	scoreConfigsListCmd.Flags().
	...
	scoreConfigsGetCmd.Flags().
		StringVarP(&scoreConfigsGetOrg, "organization", "o", "", "Organization name")
	scoreConfigsGetCmd.Flags().
	...
	scoreConfigsCreateCmd.Flags().
		StringVarP(&scoreConfigsCreateOrg, "organization", "o", "", "Organization name")
	scoreConfigsCreateCmd.Flags().
	...
	scoreConfigsUpdateCmd.Flags().
		StringVarP(&scoreConfigsUpdateOrg, "organization", "o", "", "Organization name")
	scoreConfigsUpdateCmd.Flags().
