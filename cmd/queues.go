...
This command requires API key authentication.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		body, err := inputs.BuildQueueCreateBody(
			args[0],
...
func init() {
	...
	queuesListCmd.Flags().
		StringVarP(&queuesListOrg, "organization", "o", "", "Organization name")
	queuesListCmd.Flags().
	...
	queuesGetCmd.Flags().
		StringVarP(&queuesGetOrg, "organization", "o", "", "Organization name")
	queuesGetCmd.Flags().
	...
	queuesCreateCmd.Flags().
		StringVarP(&queuesCreateOrg, "organization", "o", "", "Organization name")
	queuesCreateCmd.Flags().
	...
	queuesAssignCmd.Flags().
		StringVarP(&queuesAssignOrg, "organization", "o", "", "Organization name")
	queuesAssignCmd.Flags().
	...
	queuesUnassignCmd.Flags().
		StringVarP(&queuesUnassignOrg, "organization", "o", "", "Organization name")
	queuesUnassignCmd.Flags().
