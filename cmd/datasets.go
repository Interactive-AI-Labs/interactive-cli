...
func init() {
	...
	datasetsListCmd.Flags().
		StringVarP(&datasetsListOrg, "organization", "o", "", "Organization name")
	datasetsListCmd.Flags().
	...
	datasetsGetCmd.Flags().
		StringVarP(&datasetsGetOrg, "organization", "o", "", "Organization name")
	datasetsGetCmd.Flags().
	...
	datasetsCreateCmd.Flags().
		StringVarP(&datasetsCreateOrg, "organization", "o", "", "Organization name")
	datasetsCreateCmd.Flags().
