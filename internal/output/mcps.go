...
func mcpSignIn(e platform.McpCatalogEntry) string {
	...
	if len(e.GrantsAllowed) == 0 || !slices.Contains(e.AuthMethods, "oauth") {
...
func mcpPermissions(e platform.McpCatalogEntry) string {
	...
	listed := TruncateList(e.ScopesSupported, 3)
...
// NeedsSignIn reports whether an MCP needs account sign-in.
